      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gradient-to-r from-green-600 to-teal-600 py-4 px-6 rounded-lg text-white mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold mb-1">👔 Competitive Operations</h2>
              <p className="text-green-50 text-sm">
                <strong>So what?</strong> Automate competitor tracking with custom playbooks and action tracking.
              </p>
            </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your competitor watchlist with automated playbooks and action tracking
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 mb-8">
          ...
          <p className="text-gray-600 mb-4">
            Monitor your key competitors and receive real-time alerts. For detailed company research,{" "}
            <Link href="/research" className="text-blue-600 hover:text-blue-700 font-medium">
