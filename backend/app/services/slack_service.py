    ...
    async def send_impact_alert(
        ...
        blocks.append({
            ...
            "elements": [
                {
                    "type": "mrkdwn",
                    "text": f"Generated by Enterprise CIA • {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}"
                }
            ]
        })
    ...
    async def send_scheduled_report(
        ...
        blocks.append({
            ...
            "elements": [
                {
                    "type": "mrkdwn",
                    "text": f"Enterprise CIA • {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}"
                }
            ]
        })
